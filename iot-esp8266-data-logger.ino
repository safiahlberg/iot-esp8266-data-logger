...
const char* fingerprint =
		"AD 4B 64 B3 67 40 B5 FC 0E 51 9B BD 25 E9 7F 88 B6 2A A3 5B";
...
void datalogger_setTimer(Datalogger* handle, const sc_eventid evid,
...
void datalogger_unsetTimer(Datalogger* handle, const sc_eventid evid) {
	sc_timer_cancel(&timer_service, evid);
}

static void button_changed(pushbutton_t *button) {
	if (!pushbutton.state)
		dataloggerIface_raise_wakeDisplay(&datalogger);
}
...
void loop() {
	...
	if (cycle_count == 0L
			|| (current_millies >= last_cycle_time + CYCLE_PERIOD)) {
...
void dataloggerIfaceNetwork_connectWiFi(const Datalogger* handle) {
	// TODO
}

sc_boolean dataloggerIfaceNetwork_isWiFiConnected(const Datalogger* handle) {
	// TODO
	return false;
}

void dataloggerIfaceNetwork_connectMqttClient(const Datalogger* handle) {
	// TODO
}

sc_boolean dataloggerIfaceNetwork_isMqttHostConnected(
		const Datalogger* handle) {
	// TODO
	return false;
}

void dataloggerIfaceNetwork_verifyFingerprint(const Datalogger* handle) {
	// TODO
}

sc_boolean dataloggerIfaceNetwork_isMqttFingerprintValid(
		const Datalogger* handle) {
	// TODO
	return false;
}

void dataloggerIfaceActive_connectMqttHost(const Datalogger* handle) {
	// TODO
}

void dataloggerIfaceActive_collectData(const Datalogger* handle) {
	// TODO
}

void dataloggerIfaceActive_publishData(const Datalogger* handle) {
	// TODO
}
